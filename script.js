window.onload = function() {
    ...
    getCity.addEventListener("submit", e => { // When the user submits something...
        ...
        refreshData(); // Display the dashboard
    ...
    function formatResponse(dataset) {
        ...
        var feels = [dataset.current.feelslike_c];
        document.getElementById("feelsDsp").innerHTML = feels + "°";
        ...
        function charts() {
            ...
            var feels_ctx = document.getElementById('feelsChart');
            var feels_chart = new Chart(feels_ctx, {
                type: 'horizontalBar',
                data: {
                    datasets: [{
                        data: [feels],
